...
const capabilityImages = {
  'ai-ml': '/assets/studios/ai-ml/main.jpg', geospatial: '/assets/studios/gis/main.jpg',
  'data-science': '/assets/studios/data-science/main.jpg', blockchain: '/assets/studios/blockchain/main.jpg',
  'web-mobile': '/assets/studios/web-mobile/main.jpg', 'design-ux': '/assets/studios/design-ux/main.jpg',
  qa: '/assets/studios/qa-security/main.jpg', 'devops-cloud': '/assets/studios/cloud-devops/main.jpg',
};

const capabilityStudioIds = {
  'ai-ml': 'ai-ml', geospatial: 'gis', 'data-science': 'data-science', blockchain: 'blockchain',
  'web-mobile': 'web-mobile', 'design-ux': 'design-ux', qa: 'qa-security', 'devops-cloud': 'cloud-devops',
};
...
export function studioDetail(slug) {
  ...
  return {
    ...
    gallery: [1, 2, 3].map((index) => `/assets/studios/${item.id}/detail-${index}.jpg`),
...
export function serviceDetail(slug) {
  const data = studioDetail(slug);
  if (!data) return null;
  return { ...data, type: 'Nexbash Service', backHref: '/#studios', backLabel: 'Back to Services' };
}
...
export function capabilityDetail(slug) {
  ...
  const studioId = capabilityStudioIds[item.id];
  return {
    type: 'Capability Spotlight', title: item.name, image: capabilityImages[item.id], intro: item.desc,
    gallery: studioId ? [1, 2, 3].map((index) => `/assets/studios/${studioId}/detail-${index}.jpg`) : undefined,
